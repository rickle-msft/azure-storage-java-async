...
public final class ContainersSetMetadataResponse extends RestResponse<ContainersSetMetadataHeaders, Void> {
     ...
     */
    public ContainersSetMetadataResponse(int statusCode, ContainersSetMetadataHeaders headers, Map<String, String> rawHeaders, Void body) {
     ...
     */
    @Override
    public ContainersSetMetadataHeaders headers() {
