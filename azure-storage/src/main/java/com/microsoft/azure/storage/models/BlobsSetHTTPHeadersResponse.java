...
public final class BlobsSetHTTPHeadersResponse extends RestResponse<BlobsSetHTTPHeadersHeaders, Void> {
     ...
     */
    public BlobsSetHTTPHeadersResponse(int statusCode, BlobsSetHTTPHeadersHeaders headers, Map<String, String> rawHeaders, Void body) {
     ...
     */
    @Override
    public BlobsSetHTTPHeadersHeaders headers() {
