...
public final class ContainersBreakLeaseResponse extends RestResponse<ContainersBreakLeaseHeaders, Void> {
     ...
     */
    public ContainersBreakLeaseResponse(int statusCode, ContainersBreakLeaseHeaders headers, Map<String, String> rawHeaders, Void body) {
     ...
     */
    @Override
    public ContainersBreakLeaseHeaders headers() {
