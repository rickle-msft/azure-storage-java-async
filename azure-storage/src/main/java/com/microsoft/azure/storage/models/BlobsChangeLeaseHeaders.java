 ...
 */
@JacksonXmlRootElement(localName = "Blobs-ChangeLease-Headers")
public final class BlobsChangeLeaseHeaders {
     ...
     */
    public BlobsChangeLeaseHeaders withETag(String eTag) {
        this.eTag = eTag;
        return this;
    }
     ...
     * @return the BlobsChangeLeaseHeaders object itself.
     */
    public BlobsChangeLeaseHeaders withLastModified(OffsetDateTime lastModified) {
     ...
     * @return the BlobsChangeLeaseHeaders object itself.
     */
    public BlobsChangeLeaseHeaders withVersion(String version) {
     ...
     * @return the BlobsChangeLeaseHeaders object itself.
     */
    public BlobsChangeLeaseHeaders withDateProperty(OffsetDateTime dateProperty) {
