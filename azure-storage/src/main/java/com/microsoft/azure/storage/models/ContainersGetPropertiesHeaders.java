 ...
 */
@JacksonXmlRootElement(localName = "Containers-GetProperties-Headers")
public final class ContainersGetPropertiesHeaders {
     ...
     */
    public ContainersGetPropertiesHeaders withMetadata(Map<String, String> metadata) {
     ...
     * @return the ContainersGetPropertiesHeaders object itself.
     */
    public ContainersGetPropertiesHeaders withETag(String eTag) {
        this.eTag = eTag;
        return this;
    }
     ...
     * @return the ContainersGetPropertiesHeaders object itself.
     */
    public ContainersGetPropertiesHeaders withLastModified(OffsetDateTime lastModified) {
     ...
     * @return the ContainersGetPropertiesHeaders object itself.
     */
    public ContainersGetPropertiesHeaders withLeaseDuration(LeaseDurationType leaseDuration) {
     ...
     * @return the ContainersGetPropertiesHeaders object itself.
     */
    public ContainersGetPropertiesHeaders withLeaseState(LeaseStateType leaseState) {
     ...
     * @return the ContainersGetPropertiesHeaders object itself.
     */
    public ContainersGetPropertiesHeaders withLeaseStatus(LeaseStatusType leaseStatus) {
     ...
     * @return the ContainersGetPropertiesHeaders object itself.
     */
    public ContainersGetPropertiesHeaders withRequestId(String requestId) {
     ...
     * @return the ContainersGetPropertiesHeaders object itself.
     */
    public ContainersGetPropertiesHeaders withVersion(String version) {
     ...
     * @return the ContainersGetPropertiesHeaders object itself.
     */
    public ContainersGetPropertiesHeaders withDateProperty(OffsetDateTime dateProperty) {
     ...
     * @return the ContainersGetPropertiesHeaders object itself.
     */
    public ContainersGetPropertiesHeaders withBlobPublicAccess(PublicAccessType blobPublicAccess) {
